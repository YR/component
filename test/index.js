...
require.register('@yr/clock/index.js#1.1.2', function(require, module, exports) {
    'use strict';
    ...
    var Debug = require('debug/browser.js#2.2.0'),
        ...
        hasImmediate = 'setImmediate' in global;
    ...
    module.exports = {
      ...
      cancel: function cancel(id) {
        switch (typeof id === 'undefined' ? 'undefined' : babelHelpers['typeof'](id)) {
          // Timeout
          case 'string':
            if (id in queue) {
...
require.register('src/index.js', function(require, module, exports) {
    ...
    var assign = require('object-assign/index.js#4.0.1'),
        clock = require('@yr/clock/index.js#1.1.2'),
...
require.register('test/fixtures/test-client.js', function(require, module, exports) {
    ...
    var ReactDom = require('react-dom/index.js#0.14.7'),
